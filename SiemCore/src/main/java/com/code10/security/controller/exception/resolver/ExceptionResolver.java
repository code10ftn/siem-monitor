package com.code10.security.controller.exception.resolver;
...
import com.code10.security.model.dto.ErrorResponse;
...
public class ExceptionResolver {
    ...
    public ResponseEntity patternSyntaxException() {
        return new ResponseEntity<>(new ErrorResponse("Invalid regex format!"), HttpStatus.BAD_REQUEST);
    }
}